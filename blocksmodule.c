// https://raw.githubusercontent.com/prody/ProDy/e66e29f8d5368d40ce51b89eb05fa3d91fd18f77/prody/dynamics/rtbtools.c
...
static struct PyModuleDef blocksmodule = {
        ...
        "RTB tools.",
        -1,
        blocksmodule_methods,
};
PyMODINIT_FUNC PyInit_blocksmodule(void) {
    import_array();
    return PyModule_Create(&blocksmodule);
}
#else
PyMODINIT_FUNC initblocksmodule(void) {

    Py_InitModule3("blocksmodule", blocksmodule_methods,
        "RTB tools.");
